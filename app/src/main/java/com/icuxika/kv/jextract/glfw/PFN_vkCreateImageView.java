...
/**
 * {@snippet :
 * enum VkResult (*PFN_vkCreateImageView)(struct VkDevice_T* device,struct VkImageViewCreateInfo* pCreateInfo,struct VkAllocationCallbacks* pAllocator,struct VkImageView_T** pView);
 * }
 */
public interface PFN_vkCreateImageView {
    ...
    static MemorySegment allocate(PFN_vkCreateImageView fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$155.const$0, fi, constants$143.const$2, scope);
    }
    static PFN_vkCreateImageView ofAddress(MemorySegment addr, Arena arena) {
