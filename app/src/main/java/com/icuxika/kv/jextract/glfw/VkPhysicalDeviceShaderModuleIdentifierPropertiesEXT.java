...
public class VkPhysicalDeviceShaderModuleIdentifierPropertiesEXT {
    ...
    public static int sType$get(MemorySegment seg) {
        return (int)constants$1008.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void sType$set(MemorySegment seg, int x) {
        constants$1008.const$4.set(seg, x);
    }
    public static int sType$get(MemorySegment seg, long index) {
        return (int)constants$1008.const$4.get(seg.asSlice(index*sizeof()));
    }
    public static void sType$set(MemorySegment seg, long index, int x) {
        constants$1008.const$4.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static MemorySegment shaderModuleIdentifierAlgorithmUUID$slice(MemorySegment seg) {
