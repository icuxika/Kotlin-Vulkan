...
/**
 * {@snippet :
 * enum VkResult (*PFN_vkCreatePrivateDataSlot)(struct VkDevice_T* device,struct VkPrivateDataSlotCreateInfo* pCreateInfo,struct VkAllocationCallbacks* pAllocator,struct VkPrivateDataSlot_T** pPrivateDataSlot);
 * }
 */
public interface PFN_vkCreatePrivateDataSlot {
    ...
    static MemorySegment allocate(PFN_vkCreatePrivateDataSlot fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$414.const$2, fi, constants$143.const$2, scope);
    }
    static PFN_vkCreatePrivateDataSlot ofAddress(MemorySegment addr, Arena arena) {
