...
public class VkSparseMemoryBind {
    ...
    public static VarHandle resourceOffset$VH() {
     ...
     * }
     */
    public static long resourceOffset$get(MemorySegment seg) {
     ...
     * }
     */
    public static void resourceOffset$set(MemorySegment seg, long x) {
        constants$60.const$0.set(seg, x);
    }
    public static long resourceOffset$get(MemorySegment seg, long index) {
        return (long)constants$60.const$0.get(seg.asSlice(index*sizeof()));
    }
    public static void resourceOffset$set(MemorySegment seg, long index, long x) {
