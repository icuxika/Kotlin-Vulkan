...
public class VkDeviceQueueInfo2 {
    ...
    public static MemorySegment pNext$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$235.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pNext$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$235.const$2.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static VarHandle queueIndex$VH() {
     ...
     * }
     */
    public static int queueIndex$get(MemorySegment seg) {
     ...
     * }
     */
    public static void queueIndex$set(MemorySegment seg, int x) {
        constants$235.const$5.set(seg, x);
    }
    public static int queueIndex$get(MemorySegment seg, long index) {
        return (int)constants$235.const$5.get(seg.asSlice(index*sizeof()));
    }
    public static void queueIndex$set(MemorySegment seg, long index, int x) {
