...
public class VkPipelineTessellationStateCreateInfo {
    ...
    public static VarHandle patchControlPoints$VH() {
     ...
     * }
     */
    public static int patchControlPoints$get(MemorySegment seg) {
     ...
     * }
     */
    public static void patchControlPoints$set(MemorySegment seg, int x) {
        constants$89.const$4.set(seg, x);
    }
    public static int patchControlPoints$get(MemorySegment seg, long index) {
        return (int)constants$89.const$4.get(seg.asSlice(index*sizeof()));
    }
    public static void patchControlPoints$set(MemorySegment seg, long index, int x) {
