...
/**
 * {@snippet :
 * enum VkResult (*PFN_vkCreateHeadlessSurfaceEXT)(struct VkInstance_T* instance,struct VkHeadlessSurfaceCreateInfoEXT* pCreateInfo,struct VkAllocationCallbacks* pAllocator,struct VkSurfaceKHR_T** pSurface);
 * }
 */
public interface PFN_vkCreateHeadlessSurfaceEXT {
    ...
    static MemorySegment allocate(PFN_vkCreateHeadlessSurfaceEXT fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$799.const$1, fi, constants$143.const$2, scope);
    }
    static PFN_vkCreateHeadlessSurfaceEXT ofAddress(MemorySegment addr, Arena arena) {
