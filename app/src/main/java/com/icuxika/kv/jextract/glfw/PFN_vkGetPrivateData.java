...
/**
 * {@snippet :
 * void (*PFN_vkGetPrivateData)(struct VkDevice_T* device,enum VkObjectType objectType,unsigned long long objectHandle,struct VkPrivateDataSlot_T* privateDataSlot,unsigned long long* pData);
 * }
 */
public interface PFN_vkGetPrivateData {
    ...
    static MemorySegment allocate(PFN_vkGetPrivateData fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$415.const$2, fi, constants$415.const$1, scope);
    }
    static PFN_vkGetPrivateData ofAddress(MemorySegment addr, Arena arena) {
