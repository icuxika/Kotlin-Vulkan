...
/**
 * {@snippet :
 * enum VkResult (*PFN_vkCreateSampler)(struct VkDevice_T* device,struct VkSamplerCreateInfo* pCreateInfo,struct VkAllocationCallbacks* pAllocator,struct VkSampler_T** pSampler);
 * }
 */
public interface PFN_vkCreateSampler {
    ...
    static MemorySegment allocate(PFN_vkCreateSampler fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$157.const$5, fi, constants$143.const$2, scope);
    }
    static PFN_vkCreateSampler ofAddress(MemorySegment addr, Arena arena) {
