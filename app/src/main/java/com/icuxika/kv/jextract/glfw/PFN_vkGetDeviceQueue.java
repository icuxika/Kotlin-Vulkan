...
/**
 * {@snippet :
 * void (*PFN_vkGetDeviceQueue)(struct VkDevice_T* device,unsigned int queueFamilyIndex,unsigned int queueIndex,struct VkQueue_T** pQueue);
 * }
 */
public interface PFN_vkGetDeviceQueue {
    ...
    static MemorySegment allocate(PFN_vkGetDeviceQueue fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$145.const$1, fi, constants$145.const$0, scope);
    }
    static PFN_vkGetDeviceQueue ofAddress(MemorySegment addr, Arena arena) {
