...
public class VkSampleLocationEXT {
    ...
    public static float x$get(MemorySegment seg) {
        return (float)constants$688.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static float x$get(MemorySegment seg, long index) {
        return (float)constants$688.const$0.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static float y$get(MemorySegment seg) {
        return (float)constants$688.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static float y$get(MemorySegment seg, long index) {
        return (float)constants$688.const$1.get(seg.asSlice(index*sizeof()));
    }
