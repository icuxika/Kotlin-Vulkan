...
public class VkDeviceGroupBindSparseInfo {
    ...
    public static VarHandle resourceDeviceIndex$VH() {
     ...
     * }
     */
    public static int resourceDeviceIndex$get(MemorySegment seg) {
     ...
     * }
     */
    public static void resourceDeviceIndex$set(MemorySegment seg, int x) {
        constants$212.const$5.set(seg, x);
    }
    public static int resourceDeviceIndex$get(MemorySegment seg, long index) {
        return (int)constants$212.const$5.get(seg.asSlice(index*sizeof()));
    }
    public static void resourceDeviceIndex$set(MemorySegment seg, long index, int x) {
        constants$212.const$5.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle memoryDeviceIndex$VH() {
     ...
     * }
     */
    public static int memoryDeviceIndex$get(MemorySegment seg) {
     ...
     * }
     */
    public static void memoryDeviceIndex$set(MemorySegment seg, int x) {
        constants$213.const$0.set(seg, x);
    }
    public static int memoryDeviceIndex$get(MemorySegment seg, long index) {
        return (int)constants$213.const$0.get(seg.asSlice(index*sizeof()));
    }
    public static void memoryDeviceIndex$set(MemorySegment seg, long index, int x) {
