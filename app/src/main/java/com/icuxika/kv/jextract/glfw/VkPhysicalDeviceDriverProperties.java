...
public class VkPhysicalDeviceDriverProperties {
    ...
    public static int sType$get(MemorySegment seg) {
        return (int)constants$302.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int sType$get(MemorySegment seg, long index) {
        return (int)constants$302.const$5.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int driverID$get(MemorySegment seg) {
        return (int)constants$303.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int driverID$get(MemorySegment seg, long index) {
        return (int)constants$303.const$1.get(seg.asSlice(index*sizeof()));
    }
