...
public class VkExternalFenceProperties {
    ...
    public static VarHandle externalFenceFeatures$VH() {
     ...
     * }
     */
    public static int externalFenceFeatures$get(MemorySegment seg) {
     ...
     * }
     */
    public static void externalFenceFeatures$set(MemorySegment seg, int x) {
        constants$252.const$2.set(seg, x);
    }
    public static int externalFenceFeatures$get(MemorySegment seg, long index) {
        return (int)constants$252.const$2.get(seg.asSlice(index*sizeof()));
    }
    public static void externalFenceFeatures$set(MemorySegment seg, long index, int x) {
