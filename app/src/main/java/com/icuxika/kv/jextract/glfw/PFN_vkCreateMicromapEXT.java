...
/**
 * {@snippet :
 * enum VkResult (*PFN_vkCreateMicromapEXT)(struct VkDevice_T* device,struct VkMicromapCreateInfoEXT* pCreateInfo,struct VkAllocationCallbacks* pAllocator,struct VkMicromapEXT_T** pMicromap);
 * }
 */
public interface PFN_vkCreateMicromapEXT {
    ...
    static MemorySegment allocate(PFN_vkCreateMicromapEXT fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$953.const$4, fi, constants$143.const$2, scope);
    }
    static PFN_vkCreateMicromapEXT ofAddress(MemorySegment addr, Arena arena) {
