...
/**
 * {@snippet :
 * void (*PFN_vkGetShaderModuleIdentifierEXT)(struct VkDevice_T* device,struct VkShaderModule_T* shaderModule,struct VkShaderModuleIdentifierEXT* pIdentifier);
 * }
 */
public interface PFN_vkGetShaderModuleIdentifierEXT {
    ...
    static MemorySegment allocate(PFN_vkGetShaderModuleIdentifierEXT fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$1010.const$3, fi, constants$142.const$0, scope);
    }
    static PFN_vkGetShaderModuleIdentifierEXT ofAddress(MemorySegment addr, Arena arena) {
