...
/**
 * {@snippet :
 * enum VkResult (*PFN_vkCreateInstance)(struct VkInstanceCreateInfo* pCreateInfo,struct VkAllocationCallbacks* pAllocator,struct VkInstance_T** pInstance);
 * }
 */
public interface PFN_vkCreateInstance {
    ...
    static MemorySegment allocate(PFN_vkCreateInstance fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$140.const$0, fi, constants$139.const$5, scope);
    }
    static PFN_vkCreateInstance ofAddress(MemorySegment addr, Arena arena) {
