...
/**
 * {@snippet :
 * enum VkResult (*PFN_vkGetDisplayModePropertiesKHR)(struct VkPhysicalDevice_T* physicalDevice,struct VkDisplayKHR_T* display,unsigned int* pPropertyCount,struct VkDisplayModePropertiesKHR* pProperties);
 * }
 */
public interface PFN_vkGetDisplayModePropertiesKHR {
    ...
    static MemorySegment allocate(PFN_vkGetDisplayModePropertiesKHR fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$450.const$0, fi, constants$143.const$2, scope);
    }
    static PFN_vkGetDisplayModePropertiesKHR ofAddress(MemorySegment addr, Arena arena) {
