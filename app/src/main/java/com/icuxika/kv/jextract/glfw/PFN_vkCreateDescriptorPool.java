...
/**
 * {@snippet :
 * enum VkResult (*PFN_vkCreateDescriptorPool)(struct VkDevice_T* device,struct VkDescriptorPoolCreateInfo* pCreateInfo,struct VkAllocationCallbacks* pAllocator,struct VkDescriptorPool_T** pDescriptorPool);
 * }
 */
public interface PFN_vkCreateDescriptorPool {
    ...
    static MemorySegment allocate(PFN_vkCreateDescriptorPool fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$158.const$3, fi, constants$143.const$2, scope);
    }
    static PFN_vkCreateDescriptorPool ofAddress(MemorySegment addr, Arena arena) {
