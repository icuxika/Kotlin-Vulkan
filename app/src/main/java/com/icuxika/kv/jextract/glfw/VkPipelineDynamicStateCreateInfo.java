...
public class VkPipelineDynamicStateCreateInfo {
    ...
    public static VarHandle dynamicStateCount$VH() {
     ...
     * }
     */
    public static int dynamicStateCount$get(MemorySegment seg) {
     ...
     * }
     */
    public static void dynamicStateCount$set(MemorySegment seg, int x) {
        constants$103.const$0.set(seg, x);
    }
    public static int dynamicStateCount$get(MemorySegment seg, long index) {
        return (int)constants$103.const$0.get(seg.asSlice(index*sizeof()));
    }
    public static void dynamicStateCount$set(MemorySegment seg, long index, int x) {
        constants$103.const$0.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle pDynamicStates$VH() {
     ...
     * }
     */
    public static MemorySegment pDynamicStates$get(MemorySegment seg) {
     ...
     * }
     */
    public static void pDynamicStates$set(MemorySegment seg, MemorySegment x) {
        constants$103.const$1.set(seg, x);
    }
    public static MemorySegment pDynamicStates$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$103.const$1.get(seg.asSlice(index*sizeof()));
    }
    public static void pDynamicStates$set(MemorySegment seg, long index, MemorySegment x) {
