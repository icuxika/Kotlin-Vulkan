...
/**
 * {@snippet :
 * void (*PFN_vkCmdSetViewport)(struct VkCommandBuffer_T* commandBuffer,unsigned int firstViewport,unsigned int viewportCount,struct VkViewport* pViewports);
 * }
 */
public interface PFN_vkCmdSetViewport {
    ...
    static MemorySegment allocate(PFN_vkCmdSetViewport fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$163.const$1, fi, constants$145.const$0, scope);
    }
    static PFN_vkCmdSetViewport ofAddress(MemorySegment addr, Arena arena) {
