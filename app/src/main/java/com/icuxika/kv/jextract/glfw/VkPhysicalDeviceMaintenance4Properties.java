...
public class VkPhysicalDeviceMaintenance4Properties {
    ...
    public static MemorySegment pNext$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$412.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pNext$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$412.const$2.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static long maxBufferSize$get(MemorySegment seg) {
        return (long)constants$412.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static long maxBufferSize$get(MemorySegment seg, long index) {
        return (long)constants$412.const$3.get(seg.asSlice(index*sizeof()));
    }
