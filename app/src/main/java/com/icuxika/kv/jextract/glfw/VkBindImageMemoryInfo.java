...
public class VkBindImageMemoryInfo {
    ...
    public static MemorySegment pNext$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$204.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pNext$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$204.const$5.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment image$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$205.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment image$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$205.const$0.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment memory$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$205.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void memory$set(MemorySegment seg, MemorySegment x) {
        constants$205.const$1.set(seg, x);
    }
    public static MemorySegment memory$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$205.const$1.get(seg.asSlice(index*sizeof()));
    }
    public static void memory$set(MemorySegment seg, long index, MemorySegment x) {
        constants$205.const$1.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static long memoryOffset$get(MemorySegment seg) {
        return (long)constants$205.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static long memoryOffset$get(MemorySegment seg, long index) {
        return (long)constants$205.const$2.get(seg.asSlice(index*sizeof()));
    }
