...
/**
 * {@snippet :
 * enum VkResult (*PFN_vkCreateFramebuffer)(struct VkDevice_T* device,struct VkFramebufferCreateInfo* pCreateInfo,struct VkAllocationCallbacks* pAllocator,struct VkFramebuffer_T** pFramebuffer);
 * }
 */
public interface PFN_vkCreateFramebuffer {
    ...
    static MemorySegment allocate(PFN_vkCreateFramebuffer fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$160.const$1, fi, constants$143.const$2, scope);
    }
    static PFN_vkCreateFramebuffer ofAddress(MemorySegment addr, Arena arena) {
