...
/**
 * {@snippet :
 * enum VkResult (*PFN_vkCreateDescriptorSetLayout)(struct VkDevice_T* device,struct VkDescriptorSetLayoutCreateInfo* pCreateInfo,struct VkAllocationCallbacks* pAllocator,struct VkDescriptorSetLayout_T** pSetLayout);
 * }
 */
public interface PFN_vkCreateDescriptorSetLayout {
    ...
    static MemorySegment allocate(PFN_vkCreateDescriptorSetLayout fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$158.const$1, fi, constants$143.const$2, scope);
    }
    static PFN_vkCreateDescriptorSetLayout ofAddress(MemorySegment addr, Arena arena) {
