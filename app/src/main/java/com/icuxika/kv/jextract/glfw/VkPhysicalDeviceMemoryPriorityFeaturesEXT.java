...
public class VkPhysicalDeviceMemoryPriorityFeaturesEXT {
    ...
    public static int sType$get(MemorySegment seg) {
        return (int)constants$782.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void sType$set(MemorySegment seg, int x) {
        constants$782.const$3.set(seg, x);
    }
    public static int sType$get(MemorySegment seg, long index) {
        return (int)constants$782.const$3.get(seg.asSlice(index*sizeof()));
    }
    public static void sType$set(MemorySegment seg, long index, int x) {
        constants$782.const$3.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static int memoryPriority$get(MemorySegment seg) {
        return (int)constants$782.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void memoryPriority$set(MemorySegment seg, int x) {
        constants$782.const$5.set(seg, x);
    }
    public static int memoryPriority$get(MemorySegment seg, long index) {
        return (int)constants$782.const$5.get(seg.asSlice(index*sizeof()));
    }
    public static void memoryPriority$set(MemorySegment seg, long index, int x) {
        constants$782.const$5.set(seg.asSlice(index*sizeof()), x);
    }
