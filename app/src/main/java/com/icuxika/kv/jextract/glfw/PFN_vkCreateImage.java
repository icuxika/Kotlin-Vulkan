...
/**
 * {@snippet :
 * enum VkResult (*PFN_vkCreateImage)(struct VkDevice_T* device,struct VkImageCreateInfo* pCreateInfo,struct VkAllocationCallbacks* pAllocator,struct VkImage_T** pImage);
 * }
 */
public interface PFN_vkCreateImage {
    ...
    static MemorySegment allocate(PFN_vkCreateImage fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$154.const$3, fi, constants$143.const$2, scope);
    }
    static PFN_vkCreateImage ofAddress(MemorySegment addr, Arena arena) {
