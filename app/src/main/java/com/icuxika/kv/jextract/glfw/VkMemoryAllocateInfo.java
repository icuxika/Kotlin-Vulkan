...
public class VkMemoryAllocateInfo {
    ...
    public static VarHandle allocationSize$VH() {
     ...
     * }
     */
    public static long allocationSize$get(MemorySegment seg) {
        return (long)constants$58.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
     ...
     * }
     */
    public static void allocationSize$set(MemorySegment seg, long x) {
        constants$58.const$5.set(seg, x);
    }
    public static long allocationSize$get(MemorySegment seg, long index) {
        return (long)constants$58.const$5.get(seg.asSlice(index*sizeof()));
    }
    public static void allocationSize$set(MemorySegment seg, long index, long x) {
        constants$58.const$5.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle memoryTypeIndex$VH() {
     ...
     * }
     */
    public static int memoryTypeIndex$get(MemorySegment seg) {
     ...
     * }
     */
    public static void memoryTypeIndex$set(MemorySegment seg, int x) {
        constants$59.const$0.set(seg, x);
    }
    public static int memoryTypeIndex$get(MemorySegment seg, long index) {
        return (int)constants$59.const$0.get(seg.asSlice(index*sizeof()));
    }
    public static void memoryTypeIndex$set(MemorySegment seg, long index, int x) {
