...
/**
 * {@snippet :
 * enum VkResult (*PFN_vkResetFences)(struct VkDevice_T* device,unsigned int fenceCount,struct VkFence_T** pFences);
 * }
 */
public interface PFN_vkResetFences {
    ...
    static MemorySegment allocate(PFN_vkResetFences fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$151.const$0, fi, constants$147.const$4, scope);
    }
    static PFN_vkResetFences ofAddress(MemorySegment addr, Arena arena) {
