...
public class VkVideoDecodeH264SessionParametersAddInfoKHR {
    ...
    public static MemorySegment pNext$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$492.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pNext$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$492.const$1.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int stdSPSCount$get(MemorySegment seg) {
        return (int)constants$492.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int stdSPSCount$get(MemorySegment seg, long index) {
        return (int)constants$492.const$2.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment pStdSPSs$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$492.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pStdSPSs$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$492.const$3.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int stdPPSCount$get(MemorySegment seg) {
        return (int)constants$492.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void stdPPSCount$set(MemorySegment seg, int x) {
        constants$492.const$4.set(seg, x);
    }
    public static int stdPPSCount$get(MemorySegment seg, long index) {
        return (int)constants$492.const$4.get(seg.asSlice(index*sizeof()));
    }
    public static void stdPPSCount$set(MemorySegment seg, long index, int x) {
        constants$492.const$4.set(seg.asSlice(index*sizeof()), x);
    }
