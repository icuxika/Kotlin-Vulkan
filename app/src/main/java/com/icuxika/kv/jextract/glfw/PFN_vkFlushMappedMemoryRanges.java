...
/**
 * {@snippet :
 * enum VkResult (*PFN_vkFlushMappedMemoryRanges)(struct VkDevice_T* device,unsigned int memoryRangeCount,struct VkMappedMemoryRange* pMemoryRanges);
 * }
 */
public interface PFN_vkFlushMappedMemoryRanges {
    ...
    static MemorySegment allocate(PFN_vkFlushMappedMemoryRanges fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$147.const$5, fi, constants$147.const$4, scope);
    }
    static PFN_vkFlushMappedMemoryRanges ofAddress(MemorySegment addr, Arena arena) {
