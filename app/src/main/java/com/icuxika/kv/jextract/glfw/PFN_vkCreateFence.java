...
/**
 * {@snippet :
 * enum VkResult (*PFN_vkCreateFence)(struct VkDevice_T* device,struct VkFenceCreateInfo* pCreateInfo,struct VkAllocationCallbacks* pAllocator,struct VkFence_T** pFence);
 * }
 */
public interface PFN_vkCreateFence {
    ...
    static MemorySegment allocate(PFN_vkCreateFence fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$150.const$4, fi, constants$143.const$2, scope);
    }
    static PFN_vkCreateFence ofAddress(MemorySegment addr, Arena arena) {
