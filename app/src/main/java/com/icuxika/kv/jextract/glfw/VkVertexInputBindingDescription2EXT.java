...
public class VkVertexInputBindingDescription2EXT {
    ...
    public static int binding$get(MemorySegment seg) {
        return (int)constants$910.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void binding$set(MemorySegment seg, int x) {
        constants$910.const$1.set(seg, x);
    }
    public static int binding$get(MemorySegment seg, long index) {
        return (int)constants$910.const$1.get(seg.asSlice(index*sizeof()));
    }
    public static void binding$set(MemorySegment seg, long index, int x) {
        constants$910.const$1.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static int divisor$get(MemorySegment seg) {
        return (int)constants$910.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int divisor$get(MemorySegment seg, long index) {
        return (int)constants$910.const$4.get(seg.asSlice(index*sizeof()));
    }
