...
public class VkImageViewSampleWeightCreateInfoQCOM {
    ...
    public static MemorySegment filterCenter$slice(MemorySegment seg) {
        return seg.asSlice(16, 8);
    }
    public static MemorySegment filterSize$slice(MemorySegment seg) {
        return seg.asSlice(24, 8);
    }
    public static VarHandle numPhases$VH() {
     ...
     * }
     */
    public static int numPhases$get(MemorySegment seg) {
        return (int)constants$981.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
     ...
     * }
     */
    public static void numPhases$set(MemorySegment seg, int x) {
        constants$981.const$4.set(seg, x);
    }
    public static int numPhases$get(MemorySegment seg, long index) {
        return (int)constants$981.const$4.get(seg.asSlice(index*sizeof()));
    }
    public static void numPhases$set(MemorySegment seg, long index, int x) {
