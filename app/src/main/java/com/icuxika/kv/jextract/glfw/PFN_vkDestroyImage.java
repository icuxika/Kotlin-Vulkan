...
/**
 * {@snippet :
 * void (*PFN_vkDestroyImage)(struct VkDevice_T* device,struct VkImage_T* image,struct VkAllocationCallbacks* pAllocator);
 * }
 */
public interface PFN_vkDestroyImage {
    ...
    static MemorySegment allocate(PFN_vkDestroyImage fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$154.const$4, fi, constants$142.const$0, scope);
    }
    static PFN_vkDestroyImage ofAddress(MemorySegment addr, Arena arena) {
