...
public class VkCommandBufferAllocateInfo {
    ...
    public static MemorySegment pNext$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$131.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pNext$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$131.const$1.get(seg.asSlice(index*sizeof()));
    }
    public static void pNext$set(MemorySegment seg, long index, MemorySegment x) {
        constants$131.const$1.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle commandPool$VH() {
     ...
     * }
     */
    public static MemorySegment commandPool$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$131.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
     ...
     * }
     */
    public static void commandPool$set(MemorySegment seg, MemorySegment x) {
        constants$131.const$2.set(seg, x);
    }
    public static MemorySegment commandPool$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$131.const$2.get(seg.asSlice(index*sizeof()));
    }
    public static void commandPool$set(MemorySegment seg, long index, MemorySegment x) {
