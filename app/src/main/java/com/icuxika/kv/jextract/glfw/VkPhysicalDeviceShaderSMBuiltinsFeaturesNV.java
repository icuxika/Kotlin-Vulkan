...
public class VkPhysicalDeviceShaderSMBuiltinsFeaturesNV {
    ...
    public static int sType$get(MemorySegment seg) {
        return (int)constants$700.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int sType$get(MemorySegment seg, long index) {
        return (int)constants$700.const$3.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static VarHandle shaderSMBuiltins$VH() {
     ...
     * }
     */
    public static int shaderSMBuiltins$get(MemorySegment seg) {
     ...
     * }
     */
    public static void shaderSMBuiltins$set(MemorySegment seg, int x) {
        constants$700.const$5.set(seg, x);
    }
    public static int shaderSMBuiltins$get(MemorySegment seg, long index) {
        return (int)constants$700.const$5.get(seg.asSlice(index*sizeof()));
    }
    public static void shaderSMBuiltins$set(MemorySegment seg, long index, int x) {
