...
public class _wfinddata64_t {
     ...
     * }
     */
    public static long time_create$get(MemorySegment seg) {
        return (long)constants$22.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
     ...
     * }
     */
    public static void time_create$set(MemorySegment seg, long x) {
        constants$22.const$2.set(seg, x);
    }
    public static long time_create$get(MemorySegment seg, long index) {
        return (long)constants$22.const$2.get(seg.asSlice(index*sizeof()));
    }
    public static void time_create$set(MemorySegment seg, long index, long x) {
     ...
     * }
     */
    public static long time_access$get(MemorySegment seg) {
        return (long)constants$22.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
     ...
     * }
     */
    public static void time_access$set(MemorySegment seg, long x) {
        constants$22.const$3.set(seg, x);
    }
    public static long time_access$get(MemorySegment seg, long index) {
        return (long)constants$22.const$3.get(seg.asSlice(index*sizeof()));
    }
    public static void time_access$set(MemorySegment seg, long index, long x) {
     ...
     * }
     */
    public static long time_write$get(MemorySegment seg) {
     ...
     * }
     */
    public static void time_write$set(MemorySegment seg, long x) {
        constants$22.const$4.set(seg, x);
    }
    public static long time_write$get(MemorySegment seg, long index) {
        return (long)constants$22.const$4.get(seg.asSlice(index*sizeof()));
    }
    public static void time_write$set(MemorySegment seg, long index, long x) {
