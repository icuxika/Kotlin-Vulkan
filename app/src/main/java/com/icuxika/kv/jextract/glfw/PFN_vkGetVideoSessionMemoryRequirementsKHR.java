...
/**
 * {@snippet :
 * enum VkResult (*PFN_vkGetVideoSessionMemoryRequirementsKHR)(struct VkDevice_T* device,struct VkVideoSessionKHR_T* videoSession,unsigned int* pMemoryRequirementsCount,struct VkVideoSessionMemoryRequirementsKHR* pMemoryRequirements);
 * }
 */
public interface PFN_vkGetVideoSessionMemoryRequirementsKHR {
    ...
    static MemorySegment allocate(PFN_vkGetVideoSessionMemoryRequirementsKHR fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$470.const$3, fi, constants$143.const$2, scope);
    }
    static PFN_vkGetVideoSessionMemoryRequirementsKHR ofAddress(MemorySegment addr, Arena arena) {
