...
public class VkPipelineShaderStageRequiredSubgroupSizeCreateInfo {
    ...
    public static VarHandle requiredSubgroupSize$VH() {
     ...
     * }
     */
    public static int requiredSubgroupSize$get(MemorySegment seg) {
     ...
     * }
     */
    public static void requiredSubgroupSize$set(MemorySegment seg, int x) {
        constants$391.const$3.set(seg, x);
    }
    public static int requiredSubgroupSize$get(MemorySegment seg, long index) {
        return (int)constants$391.const$3.get(seg.asSlice(index*sizeof()));
    }
    public static void requiredSubgroupSize$set(MemorySegment seg, long index, int x) {
