...
public class VkImageViewCreateInfo {
    ...
    public static VarHandle viewType$VH() {
     ...
     * }
     */
    public static int viewType$get(MemorySegment seg) {
     ...
     * }
     */
    public static void viewType$set(MemorySegment seg, int x) {
        constants$78.const$5.set(seg, x);
    }
    public static int viewType$get(MemorySegment seg, long index) {
        return (int)constants$78.const$5.get(seg.asSlice(index*sizeof()));
    }
    public static void viewType$set(MemorySegment seg, long index, int x) {
