...
/**
 * {@snippet :
 * void (*PFN_vkCmdDrawIndirectCount)(struct VkCommandBuffer_T* commandBuffer,struct VkBuffer_T* buffer,unsigned long long offset,struct VkBuffer_T* countBuffer,unsigned long long countBufferOffset,unsigned int maxDrawCount,unsigned int stride);
 * }
 */
public interface PFN_vkCmdDrawIndirectCount {
    ...
    static MemorySegment allocate(PFN_vkCmdDrawIndirectCount fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$342.const$1, fi, constants$342.const$0, scope);
    }
    static PFN_vkCmdDrawIndirectCount ofAddress(MemorySegment addr, Arena arena) {
