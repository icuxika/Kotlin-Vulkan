...
public class VkProtectedSubmitInfo {
    ...
    public static VarHandle protectedSubmit$VH() {
     ...
     * }
     */
    public static int protectedSubmit$get(MemorySegment seg) {
     ...
     * }
     */
    public static void protectedSubmit$set(MemorySegment seg, int x) {
        constants$236.const$3.set(seg, x);
    }
    public static int protectedSubmit$get(MemorySegment seg, long index) {
        return (int)constants$236.const$3.get(seg.asSlice(index*sizeof()));
    }
    public static void protectedSubmit$set(MemorySegment seg, long index, int x) {
