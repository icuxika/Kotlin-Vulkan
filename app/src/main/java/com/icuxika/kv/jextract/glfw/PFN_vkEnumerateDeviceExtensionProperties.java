...
/**
 * {@snippet :
 * enum VkResult (*PFN_vkEnumerateDeviceExtensionProperties)(struct VkPhysicalDevice_T* physicalDevice,char* pLayerName,unsigned int* pPropertyCount,struct VkExtensionProperties* pProperties);
 * }
 */
public interface PFN_vkEnumerateDeviceExtensionProperties {
    ...
    static MemorySegment allocate(PFN_vkEnumerateDeviceExtensionProperties fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$144.const$1, fi, constants$143.const$2, scope);
    }
    static PFN_vkEnumerateDeviceExtensionProperties ofAddress(MemorySegment addr, Arena arena) {
