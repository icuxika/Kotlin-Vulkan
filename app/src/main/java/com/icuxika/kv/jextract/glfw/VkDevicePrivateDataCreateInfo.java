...
public class VkDevicePrivateDataCreateInfo {
    ...
    public static MemorySegment pNext$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$362.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pNext$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$362.const$5.get(seg.asSlice(index*sizeof()));
    }
    public static void pNext$set(MemorySegment seg, long index, MemorySegment x) {
        constants$362.const$5.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle privateDataSlotRequestCount$VH() {
     ...
     * }
     */
    public static int privateDataSlotRequestCount$get(MemorySegment seg) {
     ...
     * }
     */
    public static void privateDataSlotRequestCount$set(MemorySegment seg, int x) {
        constants$363.const$0.set(seg, x);
    }
    public static int privateDataSlotRequestCount$get(MemorySegment seg, long index) {
        return (int)constants$363.const$0.get(seg.asSlice(index*sizeof()));
    }
    public static void privateDataSlotRequestCount$set(MemorySegment seg, long index, int x) {
