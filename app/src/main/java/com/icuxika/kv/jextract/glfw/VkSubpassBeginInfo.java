...
public class VkSubpassBeginInfo {
     ...
     * }
     */
    public static int contents$get(MemorySegment seg) {
        return (int)constants$301.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
     ...
     * }
     */
    public static void contents$set(MemorySegment seg, int x) {
        constants$301.const$0.set(seg, x);
    }
    public static int contents$get(MemorySegment seg, long index) {
        return (int)constants$301.const$0.get(seg.asSlice(index*sizeof()));
    }
    public static void contents$set(MemorySegment seg, long index, int x) {
