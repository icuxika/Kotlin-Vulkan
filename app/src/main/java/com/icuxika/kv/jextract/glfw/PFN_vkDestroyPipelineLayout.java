...
/**
 * {@snippet :
 * void (*PFN_vkDestroyPipelineLayout)(struct VkDevice_T* device,struct VkPipelineLayout_T* pipelineLayout,struct VkAllocationCallbacks* pAllocator);
 * }
 */
public interface PFN_vkDestroyPipelineLayout {
    ...
    static MemorySegment allocate(PFN_vkDestroyPipelineLayout fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$157.const$4, fi, constants$142.const$0, scope);
    }
    static PFN_vkDestroyPipelineLayout ofAddress(MemorySegment addr, Arena arena) {
