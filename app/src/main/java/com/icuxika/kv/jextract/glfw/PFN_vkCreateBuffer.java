...
/**
 * {@snippet :
 * enum VkResult (*PFN_vkCreateBuffer)(struct VkDevice_T* device,struct VkBufferCreateInfo* pCreateInfo,struct VkAllocationCallbacks* pAllocator,struct VkBuffer_T** pBuffer);
 * }
 */
public interface PFN_vkCreateBuffer {
    ...
    static MemorySegment allocate(PFN_vkCreateBuffer fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$153.const$5, fi, constants$143.const$2, scope);
    }
    static PFN_vkCreateBuffer ofAddress(MemorySegment addr, Arena arena) {
