...
public interface GLFWdeallocatefun {
    ...
    static MemorySegment allocate(GLFWdeallocatefun fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$1150.const$4, fi, constants$14.const$0, scope);
    }
    static GLFWdeallocatefun ofAddress(MemorySegment addr, Arena arena) {
