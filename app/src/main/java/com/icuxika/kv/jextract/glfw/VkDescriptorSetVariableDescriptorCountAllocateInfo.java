...
public class VkDescriptorSetVariableDescriptorCountAllocateInfo {
    ...
    public static int descriptorSetCount$get(MemorySegment seg) {
        return (int)constants$317.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int descriptorSetCount$get(MemorySegment seg, long index) {
        return (int)constants$317.const$5.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static VarHandle pDescriptorCounts$VH() {
     ...
     * }
     */
    public static MemorySegment pDescriptorCounts$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$318.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
     ...
     * }
     */
    public static void pDescriptorCounts$set(MemorySegment seg, MemorySegment x) {
        constants$318.const$0.set(seg, x);
    }
    public static MemorySegment pDescriptorCounts$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$318.const$0.get(seg.asSlice(index*sizeof()));
    }
    public static void pDescriptorCounts$set(MemorySegment seg, long index, MemorySegment x) {
