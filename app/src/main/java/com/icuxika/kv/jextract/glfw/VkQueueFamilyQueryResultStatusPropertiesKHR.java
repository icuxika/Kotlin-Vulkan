...
public class VkQueueFamilyQueryResultStatusPropertiesKHR {
    ...
    public static MemorySegment pNext$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$453.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pNext$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$453.const$5.get(seg.asSlice(index*sizeof()));
    }
    public static void pNext$set(MemorySegment seg, long index, MemorySegment x) {
        constants$453.const$5.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle queryResultStatusSupport$VH() {
     ...
     * }
     */
    public static int queryResultStatusSupport$get(MemorySegment seg) {
     ...
     * }
     */
    public static void queryResultStatusSupport$set(MemorySegment seg, int x) {
        constants$454.const$0.set(seg, x);
    }
    public static int queryResultStatusSupport$get(MemorySegment seg, long index) {
        return (int)constants$454.const$0.get(seg.asSlice(index*sizeof()));
    }
    public static void queryResultStatusSupport$set(MemorySegment seg, long index, int x) {
