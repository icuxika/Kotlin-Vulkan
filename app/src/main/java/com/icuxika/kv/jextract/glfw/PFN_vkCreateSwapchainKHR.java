...
/**
 * {@snippet :
 * enum VkResult (*PFN_vkCreateSwapchainKHR)(struct VkDevice_T* device,struct VkSwapchainCreateInfoKHR* pCreateInfo,struct VkAllocationCallbacks* pAllocator,struct VkSwapchainKHR_T** pSwapchain);
 * }
 */
public interface PFN_vkCreateSwapchainKHR {
    ...
    static MemorySegment allocate(PFN_vkCreateSwapchainKHR fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$441.const$2, fi, constants$143.const$2, scope);
    }
    static PFN_vkCreateSwapchainKHR ofAddress(MemorySegment addr, Arena arena) {
