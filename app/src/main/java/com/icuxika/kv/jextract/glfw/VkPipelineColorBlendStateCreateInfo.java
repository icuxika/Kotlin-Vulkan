...
public class VkPipelineColorBlendStateCreateInfo {
     ...
     * }
     */
    public static int logicOpEnable$get(MemorySegment seg) {
     ...
     * }
     */
    public static void logicOpEnable$set(MemorySegment seg, int x) {
        constants$101.const$4.set(seg, x);
    }
    public static int logicOpEnable$get(MemorySegment seg, long index) {
        return (int)constants$101.const$4.get(seg.asSlice(index*sizeof()));
    }
    public static void logicOpEnable$set(MemorySegment seg, long index, int x) {
    ...
    public static MemorySegment blendConstants$slice(MemorySegment seg) {
