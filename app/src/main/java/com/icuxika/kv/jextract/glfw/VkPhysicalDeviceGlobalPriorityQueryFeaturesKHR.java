...
public class VkPhysicalDeviceGlobalPriorityQueryFeaturesKHR {
    ...
    public static int sType$get(MemorySegment seg) {
        return (int)constants$572.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int sType$get(MemorySegment seg, long index) {
        return (int)constants$572.const$3.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static VarHandle globalPriorityQuery$VH() {
     ...
     * }
     */
    public static int globalPriorityQuery$get(MemorySegment seg) {
     ...
     * }
     */
    public static void globalPriorityQuery$set(MemorySegment seg, int x) {
        constants$572.const$5.set(seg, x);
    }
    public static int globalPriorityQuery$get(MemorySegment seg, long index) {
        return (int)constants$572.const$5.get(seg.asSlice(index*sizeof()));
    }
    public static void globalPriorityQuery$set(MemorySegment seg, long index, int x) {
