...
/**
 * {@snippet :
 * enum VkResult (*PFN_vkCreateVideoSessionKHR)(struct VkDevice_T* device,struct VkVideoSessionCreateInfoKHR* pCreateInfo,struct VkAllocationCallbacks* pAllocator,struct VkVideoSessionKHR_T** pVideoSession);
 * }
 */
public interface PFN_vkCreateVideoSessionKHR {
    ...
    static MemorySegment allocate(PFN_vkCreateVideoSessionKHR fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$470.const$1, fi, constants$143.const$2, scope);
    }
    static PFN_vkCreateVideoSessionKHR ofAddress(MemorySegment addr, Arena arena) {
