...
/**
 * {@snippet :
 * enum VkResult (*PFN_vkGetSwapchainImagesKHR)(struct VkDevice_T* device,struct VkSwapchainKHR_T* swapchain,unsigned int* pSwapchainImageCount,struct VkImage_T** pSwapchainImages);
 * }
 */
public interface PFN_vkGetSwapchainImagesKHR {
    ...
    static MemorySegment allocate(PFN_vkGetSwapchainImagesKHR fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$441.const$4, fi, constants$143.const$2, scope);
    }
    static PFN_vkGetSwapchainImagesKHR ofAddress(MemorySegment addr, Arena arena) {
