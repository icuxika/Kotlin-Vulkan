...
/**
 * {@snippet :
 * enum VkResult (*PFN_vkGetShaderBinaryDataEXT)(struct VkDevice_T* device,struct VkShaderEXT_T* shader,unsigned long long* pDataSize,void* pData);
 * }
 */
public interface PFN_vkGetShaderBinaryDataEXT {
    ...
    static MemorySegment allocate(PFN_vkGetShaderBinaryDataEXT fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$1027.const$0, fi, constants$143.const$2, scope);
    }
    static PFN_vkGetShaderBinaryDataEXT ofAddress(MemorySegment addr, Arena arena) {
