...
/**
 * {@snippet :
 * enum VkResult (*PFN_vkCreateRenderPass2)(struct VkDevice_T* device,struct VkRenderPassCreateInfo2* pCreateInfo,struct VkAllocationCallbacks* pAllocator,struct VkRenderPass_T** pRenderPass);
 * }
 */
public interface PFN_vkCreateRenderPass2 {
    ...
    static MemorySegment allocate(PFN_vkCreateRenderPass2 fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$342.const$4, fi, constants$143.const$2, scope);
    }
    static PFN_vkCreateRenderPass2 ofAddress(MemorySegment addr, Arena arena) {
