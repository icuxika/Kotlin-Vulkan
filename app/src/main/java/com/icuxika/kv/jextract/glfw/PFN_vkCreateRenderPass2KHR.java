...
/**
 * {@snippet :
 * enum VkResult (*PFN_vkCreateRenderPass2KHR)(struct VkDevice_T* device,struct VkRenderPassCreateInfo2* pCreateInfo,struct VkAllocationCallbacks* pAllocator,struct VkRenderPass_T** pRenderPass);
 * }
 */
public interface PFN_vkCreateRenderPass2KHR {
    ...
    static MemorySegment allocate(PFN_vkCreateRenderPass2KHR fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$514.const$5, fi, constants$143.const$2, scope);
    }
    static PFN_vkCreateRenderPass2KHR ofAddress(MemorySegment addr, Arena arena) {
