...
/**
 * {@snippet :
 * void (*PFN_vkDestroyPipeline)(struct VkDevice_T* device,struct VkPipeline_T* pipeline,struct VkAllocationCallbacks* pAllocator);
 * }
 */
public interface PFN_vkDestroyPipeline {
    ...
    static MemorySegment allocate(PFN_vkDestroyPipeline fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$157.const$2, fi, constants$142.const$0, scope);
    }
    static PFN_vkDestroyPipeline ofAddress(MemorySegment addr, Arena arena) {
