...
public class VkSpecializationMapEntry {
    ...
    public static VarHandle constantID$VH() {
     ...
     * }
     */
    public static int constantID$get(MemorySegment seg) {
     ...
     * }
     */
    public static void constantID$set(MemorySegment seg, int x) {
        constants$81.const$2.set(seg, x);
    }
    public static int constantID$get(MemorySegment seg, long index) {
        return (int)constants$81.const$2.get(seg.asSlice(index*sizeof()));
    }
    public static void constantID$set(MemorySegment seg, long index, int x) {
    ...
    public static long size$get(MemorySegment seg) {
        return (long)constants$81.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static long size$get(MemorySegment seg, long index) {
        return (long)constants$81.const$4.get(seg.asSlice(index*sizeof()));
    }
