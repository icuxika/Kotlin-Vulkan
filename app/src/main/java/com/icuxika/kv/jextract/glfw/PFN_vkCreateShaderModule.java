...
/**
 * {@snippet :
 * enum VkResult (*PFN_vkCreateShaderModule)(struct VkDevice_T* device,struct VkShaderModuleCreateInfo* pCreateInfo,struct VkAllocationCallbacks* pAllocator,struct VkShaderModule_T** pShaderModule);
 * }
 */
public interface PFN_vkCreateShaderModule {
    ...
    static MemorySegment allocate(PFN_vkCreateShaderModule fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$155.const$2, fi, constants$143.const$2, scope);
    }
    static PFN_vkCreateShaderModule ofAddress(MemorySegment addr, Arena arena) {
