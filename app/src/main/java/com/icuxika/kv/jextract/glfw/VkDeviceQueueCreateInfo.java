...
public class VkDeviceQueueCreateInfo {
    ...
    public static VarHandle pQueuePriorities$VH() {
     ...
     * }
     */
    public static MemorySegment pQueuePriorities$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$52.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
     ...
     * }
     */
    public static void pQueuePriorities$set(MemorySegment seg, MemorySegment x) {
        constants$52.const$5.set(seg, x);
    }
    public static MemorySegment pQueuePriorities$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$52.const$5.get(seg.asSlice(index*sizeof()));
    }
    public static void pQueuePriorities$set(MemorySegment seg, long index, MemorySegment x) {
