...
/**
 * {@snippet :
 * void (*PFN_vkDestroyRenderPass)(struct VkDevice_T* device,struct VkRenderPass_T* renderPass,struct VkAllocationCallbacks* pAllocator);
 * }
 */
public interface PFN_vkDestroyRenderPass {
    ...
    static MemorySegment allocate(PFN_vkDestroyRenderPass fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$160.const$4, fi, constants$142.const$0, scope);
    }
    static PFN_vkDestroyRenderPass ofAddress(MemorySegment addr, Arena arena) {
