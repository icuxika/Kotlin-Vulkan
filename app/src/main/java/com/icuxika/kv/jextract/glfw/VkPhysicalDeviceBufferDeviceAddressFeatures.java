...
public class VkPhysicalDeviceBufferDeviceAddressFeatures {
    ...
    public static int sType$get(MemorySegment seg) {
        return (int)constants$338.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int sType$get(MemorySegment seg, long index) {
        return (int)constants$338.const$3.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment pNext$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$338.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pNext$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$338.const$4.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int bufferDeviceAddress$get(MemorySegment seg) {
        return (int)constants$338.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int bufferDeviceAddress$get(MemorySegment seg, long index) {
        return (int)constants$338.const$5.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int bufferDeviceAddressMultiDevice$get(MemorySegment seg) {
        return (int)constants$339.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int bufferDeviceAddressMultiDevice$get(MemorySegment seg, long index) {
        return (int)constants$339.const$1.get(seg.asSlice(index*sizeof()));
    }
