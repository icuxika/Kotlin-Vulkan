...
public class VkPhysicalDeviceTimelineSemaphoreProperties {
    ...
    public static int sType$get(MemorySegment seg) {
        return (int)constants$333.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int sType$get(MemorySegment seg, long index) {
        return (int)constants$333.const$5.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment pNext$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$334.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pNext$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$334.const$0.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static long maxTimelineSemaphoreValueDifference$get(MemorySegment seg) {
        return (long)constants$334.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static long maxTimelineSemaphoreValueDifference$get(MemorySegment seg, long index) {
        return (long)constants$334.const$1.get(seg.asSlice(index*sizeof()));
    }
