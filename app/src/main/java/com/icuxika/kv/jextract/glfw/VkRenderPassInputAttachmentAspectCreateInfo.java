...
public class VkRenderPassInputAttachmentAspectCreateInfo {
    ...
    public static VarHandle aspectReferenceCount$VH() {
     ...
     * }
     */
    public static int aspectReferenceCount$get(MemorySegment seg) {
     ...
     * }
     */
    public static void aspectReferenceCount$set(MemorySegment seg, int x) {
        constants$227.const$5.set(seg, x);
    }
    public static int aspectReferenceCount$get(MemorySegment seg, long index) {
        return (int)constants$227.const$5.get(seg.asSlice(index*sizeof()));
    }
    public static void aspectReferenceCount$set(MemorySegment seg, long index, int x) {
        constants$227.const$5.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle pAspectReferences$VH() {
     ...
     * }
     */
    public static MemorySegment pAspectReferences$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$228.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
     ...
     * }
     */
    public static void pAspectReferences$set(MemorySegment seg, MemorySegment x) {
        constants$228.const$0.set(seg, x);
    }
    public static MemorySegment pAspectReferences$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$228.const$0.get(seg.asSlice(index*sizeof()));
    }
    public static void pAspectReferences$set(MemorySegment seg, long index, MemorySegment x) {
