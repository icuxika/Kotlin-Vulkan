...
public class VkDeviceGroupDeviceCreateInfo {
    ...
    public static MemorySegment pNext$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$216.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pNext$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$216.const$2.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static VarHandle pPhysicalDevices$VH() {
     ...
     * }
     */
    public static MemorySegment pPhysicalDevices$get(MemorySegment seg) {
     ...
     * }
     */
    public static void pPhysicalDevices$set(MemorySegment seg, MemorySegment x) {
        constants$216.const$4.set(seg, x);
    }
    public static MemorySegment pPhysicalDevices$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$216.const$4.get(seg.asSlice(index*sizeof()));
    }
    public static void pPhysicalDevices$set(MemorySegment seg, long index, MemorySegment x) {
