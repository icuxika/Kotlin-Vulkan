...
/**
 * {@snippet :
 * enum VkResult (*PFN_vkCreateCuFunctionNVX)(struct VkDevice_T* device,struct VkCuFunctionCreateInfoNVX* pCreateInfo,struct VkAllocationCallbacks* pAllocator,struct VkCuFunctionNVX_T** pFunction);
 * }
 */
public interface PFN_vkCreateCuFunctionNVX {
    ...
    static MemorySegment allocate(PFN_vkCreateCuFunctionNVX fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$634.const$0, fi, constants$143.const$2, scope);
    }
    static PFN_vkCreateCuFunctionNVX ofAddress(MemorySegment addr, Arena arena) {
