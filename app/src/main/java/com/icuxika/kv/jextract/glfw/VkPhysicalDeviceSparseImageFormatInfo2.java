...
public class VkPhysicalDeviceSparseImageFormatInfo2 {
    ...
    public static MemorySegment pNext$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$225.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pNext$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$225.const$0.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int samples$get(MemorySegment seg) {
        return (int)constants$225.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int samples$get(MemorySegment seg, long index) {
        return (int)constants$225.const$3.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int usage$get(MemorySegment seg) {
        return (int)constants$225.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int usage$get(MemorySegment seg, long index) {
        return (int)constants$225.const$4.get(seg.asSlice(index*sizeof()));
    }
