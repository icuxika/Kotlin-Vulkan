...
public class VkPhysicalDeviceShaderAtomicInt64Features {
    ...
    public static int sType$get(MemorySegment seg) {
        return (int)constants$303.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int sType$get(MemorySegment seg, long index) {
        return (int)constants$303.const$3.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int shaderSharedInt64Atomics$get(MemorySegment seg) {
        return (int)constants$304.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int shaderSharedInt64Atomics$get(MemorySegment seg, long index) {
        return (int)constants$304.const$0.get(seg.asSlice(index*sizeof()));
    }
