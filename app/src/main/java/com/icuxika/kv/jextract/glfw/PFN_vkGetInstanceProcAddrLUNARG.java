...
/**
 * {@snippet :
 * void (*)() (*PFN_vkGetInstanceProcAddrLUNARG)(struct VkInstance_T* instance,char* pName);
 * }
 */
public interface PFN_vkGetInstanceProcAddrLUNARG {
    ...
    static MemorySegment allocate(PFN_vkGetInstanceProcAddrLUNARG fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$1005.const$5, fi, constants$142.const$4, scope);
    }
    static PFN_vkGetInstanceProcAddrLUNARG ofAddress(MemorySegment addr, Arena arena) {
