...
/**
 * {@snippet :
 * enum VkResult (*PFN_vkGetPhysicalDeviceSurfaceFormats2KHR)(struct VkPhysicalDevice_T* physicalDevice,struct VkPhysicalDeviceSurfaceInfo2KHR* pSurfaceInfo,unsigned int* pSurfaceFormatCount,struct VkSurfaceFormat2KHR* pSurfaceFormats);
 * }
 */
public interface PFN_vkGetPhysicalDeviceSurfaceFormats2KHR {
    ...
    static MemorySegment allocate(PFN_vkGetPhysicalDeviceSurfaceFormats2KHR fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$530.const$1, fi, constants$143.const$2, scope);
    }
    static PFN_vkGetPhysicalDeviceSurfaceFormats2KHR ofAddress(MemorySegment addr, Arena arena) {
