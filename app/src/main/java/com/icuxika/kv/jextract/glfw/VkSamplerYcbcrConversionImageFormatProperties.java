...
public class VkSamplerYcbcrConversionImageFormatProperties {
    ...
    public static VarHandle combinedImageSamplerDescriptorCount$VH() {
     ...
     * }
     */
    public static int combinedImageSamplerDescriptorCount$get(MemorySegment seg) {
     ...
     * }
     */
    public static void combinedImageSamplerDescriptorCount$set(MemorySegment seg, int x) {
        constants$241.const$3.set(seg, x);
    }
    public static int combinedImageSamplerDescriptorCount$get(MemorySegment seg, long index) {
        return (int)constants$241.const$3.get(seg.asSlice(index*sizeof()));
    }
    public static void combinedImageSamplerDescriptorCount$set(MemorySegment seg, long index, int x) {
