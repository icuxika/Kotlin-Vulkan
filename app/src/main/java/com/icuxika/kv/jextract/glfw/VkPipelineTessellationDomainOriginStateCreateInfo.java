...
public class VkPipelineTessellationDomainOriginStateCreateInfo {
    ...
    public static int sType$get(MemorySegment seg) {
        return (int)constants$229.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int sType$get(MemorySegment seg, long index) {
        return (int)constants$229.const$0.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static VarHandle domainOrigin$VH() {
     ...
     * }
     */
    public static int domainOrigin$get(MemorySegment seg) {
     ...
     * }
     */
    public static void domainOrigin$set(MemorySegment seg, int x) {
        constants$229.const$2.set(seg, x);
    }
    public static int domainOrigin$get(MemorySegment seg, long index) {
        return (int)constants$229.const$2.get(seg.asSlice(index*sizeof()));
    }
    public static void domainOrigin$set(MemorySegment seg, long index, int x) {
