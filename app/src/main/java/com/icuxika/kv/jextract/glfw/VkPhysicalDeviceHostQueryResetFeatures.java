...
public class VkPhysicalDeviceHostQueryResetFeatures {
    ...
    public static MemorySegment pNext$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$332.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pNext$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$332.const$4.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int hostQueryReset$get(MemorySegment seg) {
        return (int)constants$332.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void hostQueryReset$set(MemorySegment seg, int x) {
        constants$332.const$5.set(seg, x);
    }
    public static int hostQueryReset$get(MemorySegment seg, long index) {
        return (int)constants$332.const$5.get(seg.asSlice(index*sizeof()));
    }
    public static void hostQueryReset$set(MemorySegment seg, long index, int x) {
        constants$332.const$5.set(seg.asSlice(index*sizeof()), x);
    }
