...
/**
 * {@snippet :
 * void (*PFN_vkDestroySamplerYcbcrConversion)(struct VkDevice_T* device,struct VkSamplerYcbcrConversion_T* ycbcrConversion,struct VkAllocationCallbacks* pAllocator);
 * }
 */
public interface PFN_vkDestroySamplerYcbcrConversion {
    ...
    static MemorySegment allocate(PFN_vkDestroySamplerYcbcrConversion fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$261.const$4, fi, constants$142.const$0, scope);
    }
    static PFN_vkDestroySamplerYcbcrConversion ofAddress(MemorySegment addr, Arena arena) {
