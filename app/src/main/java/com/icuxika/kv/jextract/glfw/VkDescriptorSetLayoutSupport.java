...
public class VkDescriptorSetLayoutSupport {
     ...
     * }
     */
    public static int supported$get(MemorySegment seg) {
     ...
     * }
     */
    public static void supported$set(MemorySegment seg, int x) {
        constants$256.const$5.set(seg, x);
    }
    public static int supported$get(MemorySegment seg, long index) {
        return (int)constants$256.const$5.get(seg.asSlice(index*sizeof()));
    }
    public static void supported$set(MemorySegment seg, long index, int x) {
