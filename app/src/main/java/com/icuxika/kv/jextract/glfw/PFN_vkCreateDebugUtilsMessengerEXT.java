...
/**
 * {@snippet :
 * enum VkResult (*PFN_vkCreateDebugUtilsMessengerEXT)(struct VkInstance_T* instance,struct VkDebugUtilsMessengerCreateInfoEXT* pCreateInfo,struct VkAllocationCallbacks* pAllocator,struct VkDebugUtilsMessengerEXT_T** pMessenger);
 * }
 */
public interface PFN_vkCreateDebugUtilsMessengerEXT {
    ...
    static MemorySegment allocate(PFN_vkCreateDebugUtilsMessengerEXT fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$685.const$3, fi, constants$143.const$2, scope);
    }
    static PFN_vkCreateDebugUtilsMessengerEXT ofAddress(MemorySegment addr, Arena arena) {
