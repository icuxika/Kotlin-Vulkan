...
/**
 * {@snippet :
 * enum VkResult (*PFN_vkGetPipelineExecutableStatisticsKHR)(struct VkDevice_T* device,struct VkPipelineExecutableInfoKHR* pExecutableInfo,unsigned int* pStatisticCount,struct VkPipelineExecutableStatisticKHR* pStatistics);
 * }
 */
public interface PFN_vkGetPipelineExecutableStatisticsKHR {
    ...
    static MemorySegment allocate(PFN_vkGetPipelineExecutableStatisticsKHR fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$591.const$2, fi, constants$143.const$2, scope);
    }
    static PFN_vkGetPipelineExecutableStatisticsKHR ofAddress(MemorySegment addr, Arena arena) {
