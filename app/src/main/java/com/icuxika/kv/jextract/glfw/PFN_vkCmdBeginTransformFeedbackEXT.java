...
/**
 * {@snippet :
 * void (*PFN_vkCmdBeginTransformFeedbackEXT)(struct VkCommandBuffer_T* commandBuffer,unsigned int firstCounterBuffer,unsigned int counterBufferCount,struct VkBuffer_T** pCounterBuffers,unsigned long long* pCounterBufferOffsets);
 * }
 */
public interface PFN_vkCmdBeginTransformFeedbackEXT {
    ...
    static MemorySegment allocate(PFN_vkCmdBeginTransformFeedbackEXT fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$627.const$1, fi, constants$167.const$0, scope);
    }
    static PFN_vkCmdBeginTransformFeedbackEXT ofAddress(MemorySegment addr, Arena arena) {
