...
/**
 * {@snippet :
 * enum VkResult (*PFN_vkGetPhysicalDeviceSurfacePresentModesKHR)(struct VkPhysicalDevice_T* physicalDevice,struct VkSurfaceKHR_T* surface,unsigned int* pPresentModeCount,enum VkPresentModeKHR* pPresentModes);
 * }
 */
public interface PFN_vkGetPhysicalDeviceSurfacePresentModesKHR {
    ...
    static MemorySegment allocate(PFN_vkGetPhysicalDeviceSurfacePresentModesKHR fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$430.const$4, fi, constants$143.const$2, scope);
    }
    static PFN_vkGetPhysicalDeviceSurfacePresentModesKHR ofAddress(MemorySegment addr, Arena arena) {
