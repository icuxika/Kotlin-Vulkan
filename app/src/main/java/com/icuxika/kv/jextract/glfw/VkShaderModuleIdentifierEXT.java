...
public class VkShaderModuleIdentifierEXT {
    ...
    public static int sType$get(MemorySegment seg) {
        return (int)constants$1010.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void sType$set(MemorySegment seg, int x) {
        constants$1010.const$0.set(seg, x);
    }
    public static int sType$get(MemorySegment seg, long index) {
        return (int)constants$1010.const$0.get(seg.asSlice(index*sizeof()));
    }
    public static void sType$set(MemorySegment seg, long index, int x) {
        constants$1010.const$0.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static int identifierSize$get(MemorySegment seg) {
        return (int)constants$1010.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void identifierSize$set(MemorySegment seg, int x) {
        constants$1010.const$2.set(seg, x);
    }
    public static int identifierSize$get(MemorySegment seg, long index) {
        return (int)constants$1010.const$2.get(seg.asSlice(index*sizeof()));
    }
    public static void identifierSize$set(MemorySegment seg, long index, int x) {
        constants$1010.const$2.set(seg.asSlice(index*sizeof()), x);
    }
