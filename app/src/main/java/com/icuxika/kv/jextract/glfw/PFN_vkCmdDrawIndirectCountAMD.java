...
/**
 * {@snippet :
 * void (*PFN_vkCmdDrawIndirectCountAMD)(struct VkCommandBuffer_T* commandBuffer,struct VkBuffer_T* buffer,unsigned long long offset,struct VkBuffer_T* countBuffer,unsigned long long countBufferOffset,unsigned int maxDrawCount,unsigned int stride);
 * }
 */
public interface PFN_vkCmdDrawIndirectCountAMD {
    ...
    static MemorySegment allocate(PFN_vkCmdDrawIndirectCountAMD fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$638.const$0, fi, constants$342.const$0, scope);
    }
    static PFN_vkCmdDrawIndirectCountAMD ofAddress(MemorySegment addr, Arena arena) {
