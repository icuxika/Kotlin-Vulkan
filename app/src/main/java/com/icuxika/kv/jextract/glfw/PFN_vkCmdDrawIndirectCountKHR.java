...
/**
 * {@snippet :
 * void (*PFN_vkCmdDrawIndirectCountKHR)(struct VkCommandBuffer_T* commandBuffer,struct VkBuffer_T* buffer,unsigned long long offset,struct VkBuffer_T* countBuffer,unsigned long long countBufferOffset,unsigned int maxDrawCount,unsigned int stride);
 * }
 */
public interface PFN_vkCmdDrawIndirectCountKHR {
    ...
    static MemorySegment allocate(PFN_vkCmdDrawIndirectCountKHR fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$537.const$3, fi, constants$342.const$0, scope);
    }
    static PFN_vkCmdDrawIndirectCountKHR ofAddress(MemorySegment addr, Arena arena) {
