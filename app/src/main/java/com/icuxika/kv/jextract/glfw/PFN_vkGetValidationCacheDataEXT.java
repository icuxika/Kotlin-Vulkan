...
/**
 * {@snippet :
 * enum VkResult (*PFN_vkGetValidationCacheDataEXT)(struct VkDevice_T* device,struct VkValidationCacheEXT_T* validationCache,unsigned long long* pDataSize,void* pData);
 * }
 */
public interface PFN_vkGetValidationCacheDataEXT {
    ...
    static MemorySegment allocate(PFN_vkGetValidationCacheDataEXT fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$710.const$1, fi, constants$143.const$2, scope);
    }
    static PFN_vkGetValidationCacheDataEXT ofAddress(MemorySegment addr, Arena arena) {
