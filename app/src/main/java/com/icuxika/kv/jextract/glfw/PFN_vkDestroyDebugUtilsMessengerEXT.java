...
/**
 * {@snippet :
 * void (*PFN_vkDestroyDebugUtilsMessengerEXT)(struct VkInstance_T* instance,struct VkDebugUtilsMessengerEXT_T* messenger,struct VkAllocationCallbacks* pAllocator);
 * }
 */
public interface PFN_vkDestroyDebugUtilsMessengerEXT {
    ...
    static MemorySegment allocate(PFN_vkDestroyDebugUtilsMessengerEXT fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$685.const$4, fi, constants$142.const$0, scope);
    }
    static PFN_vkDestroyDebugUtilsMessengerEXT ofAddress(MemorySegment addr, Arena arena) {
