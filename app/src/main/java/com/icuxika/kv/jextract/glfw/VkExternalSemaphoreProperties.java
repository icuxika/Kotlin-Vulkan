...
public class VkExternalSemaphoreProperties {
    ...
    public static int exportFromImportedHandleTypes$get(MemorySegment seg) {
        return (int)constants$255.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int exportFromImportedHandleTypes$get(MemorySegment seg, long index) {
        return (int)constants$255.const$0.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int compatibleHandleTypes$get(MemorySegment seg) {
        return (int)constants$255.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int compatibleHandleTypes$get(MemorySegment seg, long index) {
        return (int)constants$255.const$1.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static VarHandle externalSemaphoreFeatures$VH() {
     ...
     * }
     */
    public static int externalSemaphoreFeatures$get(MemorySegment seg) {
     ...
     * }
     */
    public static void externalSemaphoreFeatures$set(MemorySegment seg, int x) {
        constants$255.const$2.set(seg, x);
    }
    public static int externalSemaphoreFeatures$get(MemorySegment seg, long index) {
        return (int)constants$255.const$2.get(seg.asSlice(index*sizeof()));
    }
    public static void externalSemaphoreFeatures$set(MemorySegment seg, long index, int x) {
