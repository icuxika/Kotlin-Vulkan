...
public class VkViewport {
     ...
     * }
     */
    public static float minDepth$get(MemorySegment seg) {
        return (float)constants$90.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
     ...
     * }
     */
    public static void minDepth$set(MemorySegment seg, float x) {
        constants$90.const$4.set(seg, x);
    }
    public static float minDepth$get(MemorySegment seg, long index) {
        return (float)constants$90.const$4.get(seg.asSlice(index*sizeof()));
    }
    public static void minDepth$set(MemorySegment seg, long index, float x) {
     ...
     * }
     */
    public static float maxDepth$get(MemorySegment seg) {
        return (float)constants$90.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
     ...
     * }
     */
    public static void maxDepth$set(MemorySegment seg, float x) {
        constants$90.const$5.set(seg, x);
    }
    public static float maxDepth$get(MemorySegment seg, long index) {
        return (float)constants$90.const$5.get(seg.asSlice(index*sizeof()));
    }
    public static void maxDepth$set(MemorySegment seg, long index, float x) {
