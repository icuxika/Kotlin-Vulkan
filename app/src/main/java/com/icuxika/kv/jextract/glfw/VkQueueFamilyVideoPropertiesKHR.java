...
public class VkQueueFamilyVideoPropertiesKHR {
    ...
    public static MemorySegment pNext$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$454.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pNext$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$454.const$3.get(seg.asSlice(index*sizeof()));
    }
    public static void pNext$set(MemorySegment seg, long index, MemorySegment x) {
        constants$454.const$3.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle videoCodecOperations$VH() {
     ...
     * }
     */
    public static int videoCodecOperations$get(MemorySegment seg) {
     ...
     * }
     */
    public static void videoCodecOperations$set(MemorySegment seg, int x) {
        constants$454.const$4.set(seg, x);
    }
    public static int videoCodecOperations$get(MemorySegment seg, long index) {
        return (int)constants$454.const$4.get(seg.asSlice(index*sizeof()));
    }
    public static void videoCodecOperations$set(MemorySegment seg, long index, int x) {
