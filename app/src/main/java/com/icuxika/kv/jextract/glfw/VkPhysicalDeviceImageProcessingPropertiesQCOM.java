...
public class VkPhysicalDeviceImageProcessingPropertiesQCOM {
    ...
    public static VarHandle maxWeightFilterPhases$VH() {
     ...
     * }
     */
    public static int maxWeightFilterPhases$get(MemorySegment seg) {
        return (int)constants$983.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
     ...
     * }
     */
    public static void maxWeightFilterPhases$set(MemorySegment seg, int x) {
        constants$983.const$2.set(seg, x);
    }
    public static int maxWeightFilterPhases$get(MemorySegment seg, long index) {
        return (int)constants$983.const$2.get(seg.asSlice(index*sizeof()));
    }
    public static void maxWeightFilterPhases$set(MemorySegment seg, long index, int x) {
        constants$983.const$2.set(seg.asSlice(index*sizeof()), x);
    }
    public static MemorySegment maxWeightFilterDimension$slice(MemorySegment seg) {
        return seg.asSlice(20, 8);
    }
    public static MemorySegment maxBlockMatchRegion$slice(MemorySegment seg) {
        return seg.asSlice(28, 8);
    }
    public static MemorySegment maxBoxFilterBlockSize$slice(MemorySegment seg) {
