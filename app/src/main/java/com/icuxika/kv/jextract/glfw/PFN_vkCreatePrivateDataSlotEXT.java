...
/**
 * {@snippet :
 * enum VkResult (*PFN_vkCreatePrivateDataSlotEXT)(struct VkDevice_T* device,struct VkPrivateDataSlotCreateInfo* pCreateInfo,struct VkAllocationCallbacks* pAllocator,struct VkPrivateDataSlot_T** pPrivateDataSlot);
 * }
 */
public interface PFN_vkCreatePrivateDataSlotEXT {
    ...
    static MemorySegment allocate(PFN_vkCreatePrivateDataSlotEXT fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$853.const$3, fi, constants$143.const$2, scope);
    }
    static PFN_vkCreatePrivateDataSlotEXT ofAddress(MemorySegment addr, Arena arena) {
