...
/**
 * {@snippet :
 * enum VkResult (*PFN_vkGetFenceFdKHR)(struct VkDevice_T* device,struct VkFenceGetFdInfoKHR* pGetFdInfo,int* pFd);
 * }
 */
public interface PFN_vkGetFenceFdKHR {
    ...
    static MemorySegment allocate(PFN_vkGetFenceFdKHR fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$519.const$4, fi, constants$139.const$5, scope);
    }
    static PFN_vkGetFenceFdKHR ofAddress(MemorySegment addr, Arena arena) {
