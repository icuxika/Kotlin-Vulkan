...
public class _stat32 {
    ...
    public static short st_ino$get(MemorySegment seg) {
        return (short)constants$66.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static short st_ino$get(MemorySegment seg, long index) {
        return (short)constants$66.const$0.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static short st_mode$get(MemorySegment seg) {
        return (short)constants$66.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static short st_mode$get(MemorySegment seg, long index) {
        return (short)constants$66.const$1.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static short st_nlink$get(MemorySegment seg) {
        return (short)constants$66.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static short st_nlink$get(MemorySegment seg, long index) {
        return (short)constants$66.const$2.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static short st_uid$get(MemorySegment seg) {
        return (short)constants$66.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static short st_uid$get(MemorySegment seg, long index) {
        return (short)constants$66.const$3.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static short st_gid$get(MemorySegment seg) {
        return (short)constants$66.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static short st_gid$get(MemorySegment seg, long index) {
        return (short)constants$66.const$4.get(seg.asSlice(index*sizeof()));
    }
     ...
     * }
     */
    public static int st_atime$get(MemorySegment seg) {
     ...
     * }
     */
    public static void st_atime$set(MemorySegment seg, int x) {
        constants$67.const$1.set(seg, x);
    }
    public static int st_atime$get(MemorySegment seg, long index) {
        return (int)constants$67.const$1.get(seg.asSlice(index*sizeof()));
    }
    public static void st_atime$set(MemorySegment seg, long index, int x) {
     ...
     * }
     */
    public static int st_mtime$get(MemorySegment seg) {
        return (int)constants$67.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
     ...
     * }
     */
    public static void st_mtime$set(MemorySegment seg, int x) {
        constants$67.const$2.set(seg, x);
    }
    public static int st_mtime$get(MemorySegment seg, long index) {
        return (int)constants$67.const$2.get(seg.asSlice(index*sizeof()));
    }
    public static void st_mtime$set(MemorySegment seg, long index, int x) {
     ...
     * }
     */
    public static int st_ctime$get(MemorySegment seg) {
     ...
     * }
     */
    public static void st_ctime$set(MemorySegment seg, int x) {
        constants$67.const$3.set(seg, x);
    }
    public static int st_ctime$get(MemorySegment seg, long index) {
        return (int)constants$67.const$3.get(seg.asSlice(index*sizeof()));
    }
    public static void st_ctime$set(MemorySegment seg, long index, int x) {
