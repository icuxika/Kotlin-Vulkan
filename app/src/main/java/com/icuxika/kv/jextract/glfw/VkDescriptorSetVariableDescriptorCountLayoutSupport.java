...
public class VkDescriptorSetVariableDescriptorCountLayoutSupport {
    ...
    public static VarHandle maxVariableDescriptorCount$VH() {
     ...
     * }
     */
    public static int maxVariableDescriptorCount$get(MemorySegment seg) {
     ...
     * }
     */
    public static void maxVariableDescriptorCount$set(MemorySegment seg, int x) {
        constants$318.const$4.set(seg, x);
    }
    public static int maxVariableDescriptorCount$get(MemorySegment seg, long index) {
        return (int)constants$318.const$4.get(seg.asSlice(index*sizeof()));
    }
    public static void maxVariableDescriptorCount$set(MemorySegment seg, long index, int x) {
