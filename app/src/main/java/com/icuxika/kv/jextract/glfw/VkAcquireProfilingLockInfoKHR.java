...
public class VkAcquireProfilingLockInfoKHR {
    ...
    public static MemorySegment pNext$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$525.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pNext$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$525.const$5.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static long timeout$get(MemorySegment seg) {
        return (long)constants$526.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void timeout$set(MemorySegment seg, long x) {
        constants$526.const$1.set(seg, x);
    }
    public static long timeout$get(MemorySegment seg, long index) {
        return (long)constants$526.const$1.get(seg.asSlice(index*sizeof()));
    }
    public static void timeout$set(MemorySegment seg, long index, long x) {
        constants$526.const$1.set(seg.asSlice(index*sizeof()), x);
    }
