...
/**
 * {@snippet :
 * void (*PFN_vkDestroyFence)(struct VkDevice_T* device,struct VkFence_T* fence,struct VkAllocationCallbacks* pAllocator);
 * }
 */
public interface PFN_vkDestroyFence {
    ...
    static MemorySegment allocate(PFN_vkDestroyFence fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$150.const$5, fi, constants$142.const$0, scope);
    }
    static PFN_vkDestroyFence ofAddress(MemorySegment addr, Arena arena) {
