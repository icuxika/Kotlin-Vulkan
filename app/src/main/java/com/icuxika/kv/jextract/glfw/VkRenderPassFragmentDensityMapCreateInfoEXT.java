...
public class VkRenderPassFragmentDensityMapCreateInfoEXT {
    ...
    public static int sType$get(MemorySegment seg) {
        return (int)constants$779.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void sType$set(MemorySegment seg, int x) {
        constants$779.const$1.set(seg, x);
    }
    public static int sType$get(MemorySegment seg, long index) {
        return (int)constants$779.const$1.get(seg.asSlice(index*sizeof()));
    }
    public static void sType$set(MemorySegment seg, long index, int x) {
        constants$779.const$1.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static MemorySegment fragmentDensityMapAttachment$slice(MemorySegment seg) {
