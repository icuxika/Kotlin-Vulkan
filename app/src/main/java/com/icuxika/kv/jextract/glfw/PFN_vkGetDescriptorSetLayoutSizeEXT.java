...
/**
 * {@snippet :
 * void (*PFN_vkGetDescriptorSetLayoutSizeEXT)(struct VkDevice_T* device,struct VkDescriptorSetLayout_T* layout,unsigned long long* pLayoutSizeInBytes);
 * }
 */
public interface PFN_vkGetDescriptorSetLayoutSizeEXT {
    ...
    static MemorySegment allocate(PFN_vkGetDescriptorSetLayoutSizeEXT fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$873.const$5, fi, constants$142.const$0, scope);
    }
    static PFN_vkGetDescriptorSetLayoutSizeEXT ofAddress(MemorySegment addr, Arena arena) {
