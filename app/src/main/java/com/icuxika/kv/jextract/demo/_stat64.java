...
public class _stat64 {
    ...
    public static short st_ino$get(MemorySegment seg) {
        return (short)constants$72.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static short st_ino$get(MemorySegment seg, long index) {
        return (short)constants$72.const$0.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static short st_mode$get(MemorySegment seg) {
        return (short)constants$72.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static short st_mode$get(MemorySegment seg, long index) {
        return (short)constants$72.const$1.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static short st_nlink$get(MemorySegment seg) {
        return (short)constants$72.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static short st_nlink$get(MemorySegment seg, long index) {
        return (short)constants$72.const$2.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static short st_uid$get(MemorySegment seg) {
        return (short)constants$72.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static short st_uid$get(MemorySegment seg, long index) {
        return (short)constants$72.const$3.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static short st_gid$get(MemorySegment seg) {
        return (short)constants$72.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static short st_gid$get(MemorySegment seg, long index) {
        return (short)constants$72.const$4.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static long st_size$get(MemorySegment seg) {
        return (long)constants$73.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static long st_size$get(MemorySegment seg, long index) {
        return (long)constants$73.const$0.get(seg.asSlice(index*sizeof()));
    }
