...
public class VkPhysicalDeviceLinearColorAttachmentFeaturesNV {
    ...
    public static MemorySegment pNext$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$980.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pNext$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$980.const$1.get(seg.asSlice(index*sizeof()));
    }
    public static void pNext$set(MemorySegment seg, long index, MemorySegment x) {
        constants$980.const$1.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle linearColorAttachment$VH() {
     ...
     * }
     */
    public static int linearColorAttachment$get(MemorySegment seg) {
     ...
     * }
     */
    public static void linearColorAttachment$set(MemorySegment seg, int x) {
        constants$980.const$2.set(seg, x);
    }
    public static int linearColorAttachment$get(MemorySegment seg, long index) {
        return (int)constants$980.const$2.get(seg.asSlice(index*sizeof()));
    }
    public static void linearColorAttachment$set(MemorySegment seg, long index, int x) {
