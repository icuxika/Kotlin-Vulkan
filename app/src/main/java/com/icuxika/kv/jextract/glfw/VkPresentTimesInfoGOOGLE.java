...
public class VkPresentTimesInfoGOOGLE {
    ...
    public static MemorySegment pNext$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$664.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void pNext$set(MemorySegment seg, MemorySegment x) {
        constants$664.const$1.set(seg, x);
    }
    public static MemorySegment pNext$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$664.const$1.get(seg.asSlice(index*sizeof()));
    }
    public static void pNext$set(MemorySegment seg, long index, MemorySegment x) {
        constants$664.const$1.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static int swapchainCount$get(MemorySegment seg) {
        return (int)constants$664.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int swapchainCount$get(MemorySegment seg, long index) {
        return (int)constants$664.const$2.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static VarHandle pTimes$VH() {
     ...
     * }
     */
    public static MemorySegment pTimes$get(MemorySegment seg) {
     ...
     * }
     */
    public static void pTimes$set(MemorySegment seg, MemorySegment x) {
        constants$664.const$3.set(seg, x);
    }
    public static MemorySegment pTimes$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$664.const$3.get(seg.asSlice(index*sizeof()));
    }
    public static void pTimes$set(MemorySegment seg, long index, MemorySegment x) {
