...
public class VkSurfacePresentModeEXT {
    ...
    public static int sType$get(MemorySegment seg) {
        return (int)constants$814.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int sType$get(MemorySegment seg, long index) {
        return (int)constants$814.const$2.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment pNext$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$814.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void pNext$set(MemorySegment seg, MemorySegment x) {
        constants$814.const$3.set(seg, x);
    }
    public static MemorySegment pNext$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$814.const$3.get(seg.asSlice(index*sizeof()));
    }
    public static void pNext$set(MemorySegment seg, long index, MemorySegment x) {
        constants$814.const$3.set(seg.asSlice(index*sizeof()), x);
    }
