...
public class VkBufferDeviceAddressInfo {
    ...
    public static int sType$get(MemorySegment seg) {
        return (int)constants$339.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void sType$set(MemorySegment seg, int x) {
        constants$339.const$3.set(seg, x);
    }
    public static int sType$get(MemorySegment seg, long index) {
        return (int)constants$339.const$3.get(seg.asSlice(index*sizeof()));
    }
    public static void sType$set(MemorySegment seg, long index, int x) {
        constants$339.const$3.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static MemorySegment pNext$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$339.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pNext$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$339.const$4.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment buffer$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$339.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment buffer$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$339.const$5.get(seg.asSlice(index*sizeof()));
    }
