...
public class VkImageViewMinLodCreateInfoEXT {
    ...
    public static MemorySegment pNext$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$933.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pNext$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$933.const$4.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static float minLod$get(MemorySegment seg) {
        return (float)constants$933.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static float minLod$get(MemorySegment seg, long index) {
        return (float)constants$933.const$5.get(seg.asSlice(index*sizeof()));
    }
