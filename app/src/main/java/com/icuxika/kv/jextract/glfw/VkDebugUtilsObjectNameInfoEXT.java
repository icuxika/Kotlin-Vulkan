...
public class VkDebugUtilsObjectNameInfoEXT {
    ...
    public static int sType$get(MemorySegment seg) {
        return (int)constants$678.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int sType$get(MemorySegment seg, long index) {
        return (int)constants$678.const$0.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int objectType$get(MemorySegment seg) {
        return (int)constants$678.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int objectType$get(MemorySegment seg, long index) {
        return (int)constants$678.const$2.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static long objectHandle$get(MemorySegment seg) {
        return (long)constants$678.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void objectHandle$set(MemorySegment seg, long x) {
        constants$678.const$3.set(seg, x);
    }
    public static long objectHandle$get(MemorySegment seg, long index) {
        return (long)constants$678.const$3.get(seg.asSlice(index*sizeof()));
    }
    public static void objectHandle$set(MemorySegment seg, long index, long x) {
        constants$678.const$3.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle pObjectName$VH() {
        return constants$678.const$4;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment pObjectName$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$678.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void pObjectName$set(MemorySegment seg, MemorySegment x) {
        constants$678.const$4.set(seg, x);
    }
    public static MemorySegment pObjectName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$678.const$4.get(seg.asSlice(index*sizeof()));
    }
    public static void pObjectName$set(MemorySegment seg, long index, MemorySegment x) {
        constants$678.const$4.set(seg.asSlice(index*sizeof()), x);
    }
