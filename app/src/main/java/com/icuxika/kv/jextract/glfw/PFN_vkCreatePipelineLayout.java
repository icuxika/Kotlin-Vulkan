...
/**
 * {@snippet :
 * enum VkResult (*PFN_vkCreatePipelineLayout)(struct VkDevice_T* device,struct VkPipelineLayoutCreateInfo* pCreateInfo,struct VkAllocationCallbacks* pAllocator,struct VkPipelineLayout_T** pPipelineLayout);
 * }
 */
public interface PFN_vkCreatePipelineLayout {
    ...
    static MemorySegment allocate(PFN_vkCreatePipelineLayout fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$157.const$3, fi, constants$143.const$2, scope);
    }
    static PFN_vkCreatePipelineLayout ofAddress(MemorySegment addr, Arena arena) {
