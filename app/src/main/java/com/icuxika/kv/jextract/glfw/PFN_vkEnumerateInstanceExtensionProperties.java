...
/**
 * {@snippet :
 * enum VkResult (*PFN_vkEnumerateInstanceExtensionProperties)(char* pLayerName,unsigned int* pPropertyCount,struct VkExtensionProperties* pProperties);
 * }
 */
public interface PFN_vkEnumerateInstanceExtensionProperties {
    ...
    static MemorySegment allocate(PFN_vkEnumerateInstanceExtensionProperties fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$144.const$0, fi, constants$139.const$5, scope);
    }
    static PFN_vkEnumerateInstanceExtensionProperties ofAddress(MemorySegment addr, Arena arena) {
