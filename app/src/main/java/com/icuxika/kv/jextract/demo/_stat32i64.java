...
public class _stat32i64 {
    ...
    public static int st_dev$get(MemorySegment seg) {
        return (int)constants$67.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int st_dev$get(MemorySegment seg, long index) {
        return (int)constants$67.const$5.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static short st_ino$get(MemorySegment seg) {
        return (short)constants$68.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static short st_ino$get(MemorySegment seg, long index) {
        return (short)constants$68.const$0.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static short st_mode$get(MemorySegment seg) {
        return (short)constants$68.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static short st_mode$get(MemorySegment seg, long index) {
        return (short)constants$68.const$1.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static short st_nlink$get(MemorySegment seg) {
        return (short)constants$68.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static short st_nlink$get(MemorySegment seg, long index) {
        return (short)constants$68.const$2.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static short st_gid$get(MemorySegment seg) {
        return (short)constants$68.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static short st_gid$get(MemorySegment seg, long index) {
        return (short)constants$68.const$4.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int st_atime$get(MemorySegment seg) {
        return (int)constants$69.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int st_atime$get(MemorySegment seg, long index) {
        return (int)constants$69.const$1.get(seg.asSlice(index*sizeof()));
    }
