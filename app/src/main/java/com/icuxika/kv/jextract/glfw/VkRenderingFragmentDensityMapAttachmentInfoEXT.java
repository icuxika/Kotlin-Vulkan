...
public class VkRenderingFragmentDensityMapAttachmentInfoEXT {
    ...
    public static int sType$get(MemorySegment seg) {
        return (int)constants$496.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int sType$get(MemorySegment seg, long index) {
        return (int)constants$496.const$4.get(seg.asSlice(index*sizeof()));
    }
    public static void sType$set(MemorySegment seg, long index, int x) {
        constants$496.const$4.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle pNext$VH() {
        return constants$496.const$5;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment pNext$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$496.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void pNext$set(MemorySegment seg, MemorySegment x) {
        constants$496.const$5.set(seg, x);
    }
    public static MemorySegment pNext$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$496.const$5.get(seg.asSlice(index*sizeof()));
    }
    public static void pNext$set(MemorySegment seg, long index, MemorySegment x) {
        constants$496.const$5.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static int imageLayout$get(MemorySegment seg) {
        return (int)constants$497.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int imageLayout$get(MemorySegment seg, long index) {
        return (int)constants$497.const$1.get(seg.asSlice(index*sizeof()));
    }
