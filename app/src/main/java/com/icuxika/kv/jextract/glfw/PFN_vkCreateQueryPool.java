...
/**
 * {@snippet :
 * enum VkResult (*PFN_vkCreateQueryPool)(struct VkDevice_T* device,struct VkQueryPoolCreateInfo* pCreateInfo,struct VkAllocationCallbacks* pAllocator,struct VkQueryPool_T** pQueryPool);
 * }
 */
public interface PFN_vkCreateQueryPool {
    ...
    static MemorySegment allocate(PFN_vkCreateQueryPool fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$153.const$0, fi, constants$143.const$2, scope);
    }
    static PFN_vkCreateQueryPool ofAddress(MemorySegment addr, Arena arena) {
