...
public class VkPipelineInputAssemblyStateCreateInfo {
    ...
    public static MemorySegment pNext$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$88.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pNext$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$88.const$2.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static VarHandle primitiveRestartEnable$VH() {
     ...
     * }
     */
    public static int primitiveRestartEnable$get(MemorySegment seg) {
     ...
     * }
     */
    public static void primitiveRestartEnable$set(MemorySegment seg, int x) {
        constants$88.const$5.set(seg, x);
    }
    public static int primitiveRestartEnable$get(MemorySegment seg, long index) {
        return (int)constants$88.const$5.get(seg.asSlice(index*sizeof()));
    }
    public static void primitiveRestartEnable$set(MemorySegment seg, long index, int x) {
