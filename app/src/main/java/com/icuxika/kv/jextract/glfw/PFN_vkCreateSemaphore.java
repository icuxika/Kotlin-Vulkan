...
/**
 * {@snippet :
 * enum VkResult (*PFN_vkCreateSemaphore)(struct VkDevice_T* device,struct VkSemaphoreCreateInfo* pCreateInfo,struct VkAllocationCallbacks* pAllocator,struct VkSemaphore_T** pSemaphore);
 * }
 */
public interface PFN_vkCreateSemaphore {
    ...
    static MemorySegment allocate(PFN_vkCreateSemaphore fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$151.const$5, fi, constants$143.const$2, scope);
    }
    static PFN_vkCreateSemaphore ofAddress(MemorySegment addr, Arena arena) {
