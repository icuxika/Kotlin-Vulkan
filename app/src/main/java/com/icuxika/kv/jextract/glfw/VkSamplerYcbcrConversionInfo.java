...
public class VkSamplerYcbcrConversionInfo {
    ...
    public static VarHandle conversion$VH() {
     ...
     * }
     */
    public static MemorySegment conversion$get(MemorySegment seg) {
     ...
     * }
     */
    public static void conversion$set(MemorySegment seg, MemorySegment x) {
        constants$238.const$5.set(seg, x);
    }
    public static MemorySegment conversion$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$238.const$5.get(seg.asSlice(index*sizeof()));
    }
    public static void conversion$set(MemorySegment seg, long index, MemorySegment x) {
