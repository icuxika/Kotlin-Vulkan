...
/**
 * {@snippet :
 * enum VkResult (*PFN_vkCreatePipelineCache)(struct VkDevice_T* device,struct VkPipelineCacheCreateInfo* pCreateInfo,struct VkAllocationCallbacks* pAllocator,struct VkPipelineCache_T** pPipelineCache);
 * }
 */
public interface PFN_vkCreatePipelineCache {
    ...
    static MemorySegment allocate(PFN_vkCreatePipelineCache fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$155.const$4, fi, constants$143.const$2, scope);
    }
    static PFN_vkCreatePipelineCache ofAddress(MemorySegment addr, Arena arena) {
