...
final class constants$219 {
    ...
    static final VarHandle const$0 = constants$218.const$5.varHandle(MemoryLayout.PathElement.groupElement("sType"));
    static final VarHandle const$1 = constants$218.const$5.varHandle(MemoryLayout.PathElement.groupElement("pNext"));
    ...
    static final VarHandle const$3 = constants$219.const$2.varHandle(MemoryLayout.PathElement.groupElement("sType"));
    static final VarHandle const$4 = constants$219.const$2.varHandle(MemoryLayout.PathElement.groupElement("pNext"));
