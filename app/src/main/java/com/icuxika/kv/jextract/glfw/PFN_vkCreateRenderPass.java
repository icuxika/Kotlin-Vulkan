...
/**
 * {@snippet :
 * enum VkResult (*PFN_vkCreateRenderPass)(struct VkDevice_T* device,struct VkRenderPassCreateInfo* pCreateInfo,struct VkAllocationCallbacks* pAllocator,struct VkRenderPass_T** pRenderPass);
 * }
 */
public interface PFN_vkCreateRenderPass {
    ...
    static MemorySegment allocate(PFN_vkCreateRenderPass fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$160.const$3, fi, constants$143.const$2, scope);
    }
    static PFN_vkCreateRenderPass ofAddress(MemorySegment addr, Arena arena) {
