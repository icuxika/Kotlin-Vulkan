...
/**
 * {@snippet :
 * void (*PFN_vkDestroyImageView)(struct VkDevice_T* device,struct VkImageView_T* imageView,struct VkAllocationCallbacks* pAllocator);
 * }
 */
public interface PFN_vkDestroyImageView {
    ...
    static MemorySegment allocate(PFN_vkDestroyImageView fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$155.const$1, fi, constants$142.const$0, scope);
    }
    static PFN_vkDestroyImageView ofAddress(MemorySegment addr, Arena arena) {
