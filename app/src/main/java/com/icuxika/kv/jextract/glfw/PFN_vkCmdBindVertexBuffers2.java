...
/**
 * {@snippet :
 * void (*PFN_vkCmdBindVertexBuffers2)(struct VkCommandBuffer_T* commandBuffer,unsigned int firstBinding,unsigned int bindingCount,struct VkBuffer_T** pBuffers,unsigned long long* pOffsets,unsigned long long* pSizes,unsigned long long* pStrides);
 * }
 */
public interface PFN_vkCmdBindVertexBuffers2 {
    ...
    static MemorySegment allocate(PFN_vkCmdBindVertexBuffers2 fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$419.const$4, fi, constants$419.const$3, scope);
    }
    static PFN_vkCmdBindVertexBuffers2 ofAddress(MemorySegment addr, Arena arena) {
