...
/**
 * {@snippet :
 * void (*PFN_vkDestroyCommandPool)(struct VkDevice_T* device,struct VkCommandPool_T* commandPool,struct VkAllocationCallbacks* pAllocator);
 * }
 */
public interface PFN_vkDestroyCommandPool {
    ...
    static MemorySegment allocate(PFN_vkDestroyCommandPool fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$161.const$1, fi, constants$142.const$0, scope);
    }
    static PFN_vkDestroyCommandPool ofAddress(MemorySegment addr, Arena arena) {
