...
public class VkPerformanceOverrideInfoINTEL {
    ...
    public static int sType$get(MemorySegment seg) {
        return (int)constants$770.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void sType$set(MemorySegment seg, int x) {
        constants$770.const$0.set(seg, x);
    }
    public static int sType$get(MemorySegment seg, long index) {
        return (int)constants$770.const$0.get(seg.asSlice(index*sizeof()));
    }
    public static void sType$set(MemorySegment seg, long index, int x) {
        constants$770.const$0.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static int type$get(MemorySegment seg) {
        return (int)constants$770.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void type$set(MemorySegment seg, int x) {
        constants$770.const$2.set(seg, x);
    }
    public static int type$get(MemorySegment seg, long index) {
        return (int)constants$770.const$2.get(seg.asSlice(index*sizeof()));
    }
    public static void type$set(MemorySegment seg, long index, int x) {
        constants$770.const$2.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle enable$VH() {
        return constants$770.const$3;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int enable$get(MemorySegment seg) {
        return (int)constants$770.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void enable$set(MemorySegment seg, int x) {
        constants$770.const$3.set(seg, x);
    }
    public static int enable$get(MemorySegment seg, long index) {
        return (int)constants$770.const$3.get(seg.asSlice(index*sizeof()));
    }
    public static void enable$set(MemorySegment seg, long index, int x) {
        constants$770.const$3.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle parameter$VH() {
        return constants$770.const$4;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static long parameter$get(MemorySegment seg) {
        return (long)constants$770.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void parameter$set(MemorySegment seg, long x) {
        constants$770.const$4.set(seg, x);
    }
    public static long parameter$get(MemorySegment seg, long index) {
        return (long)constants$770.const$4.get(seg.asSlice(index*sizeof()));
    }
    public static void parameter$set(MemorySegment seg, long index, long x) {
        constants$770.const$4.set(seg.asSlice(index*sizeof()), x);
    }
