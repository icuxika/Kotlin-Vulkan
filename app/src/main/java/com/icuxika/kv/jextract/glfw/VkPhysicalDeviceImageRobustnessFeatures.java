...
public class VkPhysicalDeviceImageRobustnessFeatures {
    ...
    public static int sType$get(MemorySegment seg) {
        return (int)constants$376.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int sType$get(MemorySegment seg, long index) {
        return (int)constants$376.const$3.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment pNext$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$376.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pNext$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$376.const$4.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int robustImageAccess$get(MemorySegment seg) {
        return (int)constants$376.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int robustImageAccess$get(MemorySegment seg, long index) {
        return (int)constants$376.const$5.get(seg.asSlice(index*sizeof()));
    }
