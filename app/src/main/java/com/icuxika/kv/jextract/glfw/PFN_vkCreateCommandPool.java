...
/**
 * {@snippet :
 * enum VkResult (*PFN_vkCreateCommandPool)(struct VkDevice_T* device,struct VkCommandPoolCreateInfo* pCreateInfo,struct VkAllocationCallbacks* pAllocator,struct VkCommandPool_T** pCommandPool);
 * }
 */
public interface PFN_vkCreateCommandPool {
    ...
    static MemorySegment allocate(PFN_vkCreateCommandPool fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$161.const$0, fi, constants$143.const$2, scope);
    }
    static PFN_vkCreateCommandPool ofAddress(MemorySegment addr, Arena arena) {
