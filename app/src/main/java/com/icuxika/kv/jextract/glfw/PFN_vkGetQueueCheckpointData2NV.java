...
/**
 * {@snippet :
 * void (*PFN_vkGetQueueCheckpointData2NV)(struct VkQueue_T* queue,unsigned int* pCheckpointDataCount,struct VkCheckpointData2NV* pCheckpointData);
 * }
 */
public interface PFN_vkGetQueueCheckpointData2NV {
    ...
    static MemorySegment allocate(PFN_vkGetQueueCheckpointData2NV fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$600.const$1, fi, constants$142.const$0, scope);
    }
    static PFN_vkGetQueueCheckpointData2NV ofAddress(MemorySegment addr, Arena arena) {
