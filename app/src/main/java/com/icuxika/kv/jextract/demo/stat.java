...
public class stat {
    ...
    public static short st_ino$get(MemorySegment seg) {
        return (short)constants$74.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static short st_ino$get(MemorySegment seg, long index) {
        return (short)constants$74.const$0.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static short st_mode$get(MemorySegment seg) {
        return (short)constants$74.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static short st_mode$get(MemorySegment seg, long index) {
        return (short)constants$74.const$1.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static short st_nlink$get(MemorySegment seg) {
        return (short)constants$74.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static short st_nlink$get(MemorySegment seg, long index) {
        return (short)constants$74.const$2.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static short st_uid$get(MemorySegment seg) {
        return (short)constants$74.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static short st_uid$get(MemorySegment seg, long index) {
        return (short)constants$74.const$3.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static short st_gid$get(MemorySegment seg) {
        return (short)constants$74.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static short st_gid$get(MemorySegment seg, long index) {
        return (short)constants$74.const$4.get(seg.asSlice(index*sizeof()));
    }
