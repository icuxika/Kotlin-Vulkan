...
public class VkPhysicalDeviceScalarBlockLayoutFeatures {
    ...
    public static MemorySegment pNext$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$321.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pNext$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$321.const$2.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int scalarBlockLayout$get(MemorySegment seg) {
        return (int)constants$321.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int scalarBlockLayout$get(MemorySegment seg, long index) {
        return (int)constants$321.const$3.get(seg.asSlice(index*sizeof()));
    }
