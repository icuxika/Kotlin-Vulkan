...
/**
 * {@snippet :
 * enum VkResult (*PFN_vkCreateDevice)(struct VkPhysicalDevice_T* physicalDevice,struct VkDeviceCreateInfo* pCreateInfo,struct VkAllocationCallbacks* pAllocator,struct VkDevice_T** pDevice);
 * }
 */
public interface PFN_vkCreateDevice {
    ...
    static MemorySegment allocate(PFN_vkCreateDevice fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$143.const$3, fi, constants$143.const$2, scope);
    }
    static PFN_vkCreateDevice ofAddress(MemorySegment addr, Arena arena) {
