...
/**
 * {@snippet :
 * enum VkResult (*PFN_vkGetPipelineCacheData)(struct VkDevice_T* device,struct VkPipelineCache_T* pipelineCache,unsigned long long* pDataSize,void* pData);
 * }
 */
public interface PFN_vkGetPipelineCacheData {
    ...
    static MemorySegment allocate(PFN_vkGetPipelineCacheData fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$156.const$0, fi, constants$143.const$2, scope);
    }
    static PFN_vkGetPipelineCacheData ofAddress(MemorySegment addr, Arena arena) {
