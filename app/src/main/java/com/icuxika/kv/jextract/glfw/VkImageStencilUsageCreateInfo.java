...
public class VkImageStencilUsageCreateInfo {
    ...
    public static VarHandle stencilUsage$VH() {
     ...
     * }
     */
    public static int stencilUsage$get(MemorySegment seg) {
        return (int)constants$322.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
     ...
     * }
     */
    public static void stencilUsage$set(MemorySegment seg, int x) {
        constants$322.const$1.set(seg, x);
    }
    public static int stencilUsage$get(MemorySegment seg, long index) {
        return (int)constants$322.const$1.get(seg.asSlice(index*sizeof()));
    }
    public static void stencilUsage$set(MemorySegment seg, long index, int x) {
