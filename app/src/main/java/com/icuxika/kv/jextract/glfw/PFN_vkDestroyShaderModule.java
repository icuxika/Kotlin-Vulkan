...
/**
 * {@snippet :
 * void (*PFN_vkDestroyShaderModule)(struct VkDevice_T* device,struct VkShaderModule_T* shaderModule,struct VkAllocationCallbacks* pAllocator);
 * }
 */
public interface PFN_vkDestroyShaderModule {
    ...
    static MemorySegment allocate(PFN_vkDestroyShaderModule fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$155.const$3, fi, constants$142.const$0, scope);
    }
    static PFN_vkDestroyShaderModule ofAddress(MemorySegment addr, Arena arena) {
