...
public class VkPhysicalDeviceSurfaceInfo2KHR {
    ...
    public static MemorySegment pNext$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$528.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void pNext$set(MemorySegment seg, MemorySegment x) {
        constants$528.const$4.set(seg, x);
    }
    public static MemorySegment pNext$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$528.const$4.get(seg.asSlice(index*sizeof()));
    }
    public static void pNext$set(MemorySegment seg, long index, MemorySegment x) {
        constants$528.const$4.set(seg.asSlice(index*sizeof()), x);
    }
