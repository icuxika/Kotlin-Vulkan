...
public class VkDescriptorBufferBindingPushDescriptorBufferHandleEXT {
    ...
    public static MemorySegment buffer$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$867.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment buffer$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$867.const$0.get(seg.asSlice(index*sizeof()));
    }
