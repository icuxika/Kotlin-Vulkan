...
public class VkMemoryGetFdInfoKHR {
    ...
    public static MemorySegment pNext$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$506.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pNext$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$506.const$0.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int handleType$get(MemorySegment seg) {
        return (int)constants$506.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int handleType$get(MemorySegment seg, long index) {
        return (int)constants$506.const$2.get(seg.asSlice(index*sizeof()));
    }
